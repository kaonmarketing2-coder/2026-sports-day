  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center min-h-screen px-4" style={{ background: 'linear-gradient(135deg, #1d4ed8 0%, #1e3a8a 100%)' }}>
      ...
      <div className="w-full max-w-sm">
        <Link
          href="/survey"
          className="flex flex-col items-center gap-3 bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-200 hover:-translate-y-1 text-center"
        >
